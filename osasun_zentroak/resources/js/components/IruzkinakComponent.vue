                ...
                <div v-if="hayComentarios" class="card p-3">
                    <div v-for="(comentario,i) in comentarios" :key="i" class="d-flex justify-content-between align-items-center mt-2">
                        <div class="user d-flex flex-row align-items-center"> 
                            ...
                            <div v-if="comentario.usuario == getLoggedUserName()" class="d-flex justify-content-end">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" id="trashIcon" viewBox="0 0 16 16" @click.prevent="deleteComment(comentario.id)">
