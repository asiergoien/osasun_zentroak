                ...
                <div class="card p-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="user d-flex flex-row align-items-center"> 
                         ...
                         <!--por ahora sin fecha jeje q hay q meter una columna en la bbdd y m da pereza ahora mismo pero si no aqui iria la fecha o lo q queda de ella cn un if dependiendo de hace cuanto es  -->
...
<script>
    export default {
        ...
        methods:{
            ...
            addComment(){
                axios.post('/addComment', {userId: this.userId, zentroarenKodea: this.getParams(), mensaje: this.getMensaje()})
            },
            viewComments(){
