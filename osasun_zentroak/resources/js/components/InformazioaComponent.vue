    ...
    <div>
        <div v-for="(centro, index) in centros" v-bind:key="index">
            <div v-if="centro.Zentroarenkodea === getParams()" class="row">
                ...
                <div class="col">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16" v-if="isLiked()">
                        <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16" v-else @click="like">
...
<script>
    export default {
        ...
        methods:{
            ...
            isLiked(){
                axios.get('/viewLike', {params: {userId: this.userId, zentroarenKodea: this.getParams()}})
                    .then((res)=>{
