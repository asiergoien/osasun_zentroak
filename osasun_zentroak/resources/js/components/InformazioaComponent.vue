    ...
    <div>
        <div v-for="(centro, index) in centros" v-bind:key="index">
            <div v-if="centro.Zentroarenkodea === getParams()" class="row">
                ...
                <div class="col">
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16" @click="like()">
...
<script>
    export default {
        ...
        methods:{
            ...
            like(){
                axios.post('/like', {userId: this.$props.userId, zentroarenKodea: this.getParams()})
                    .then((response)=>{
